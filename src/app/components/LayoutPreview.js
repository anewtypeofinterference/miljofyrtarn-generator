  ...
  const presets = {
    ...
    preset1: {
      '50x70cm': {
        width: 500,
        height: 700,
        overskrift1: { x: 135.5, y: 175, fontSize: '48px' },
    ...
    preset3: {
      '50x70cm': {
        width: 500,
        height: 700,
        overskrift1: { x: 120, y: 150, fontSize: '48px' },
        overskrift2: { x: 250, y: 275, fontSize: '48px' },
        overskrift3: { x: 20, y: 300, fontSize: '48px' },
      ...
      A4: {
        ...
        height: 842,
        overskrift1: { x: 120, y: 150, fontSize: '48px' },
        overskrift2: { x: 330, y: 325, fontSize: '48px' },
        overskrift3: { x: 20, y: 300, fontSize: '48px' },
      ...
      '1080x1080': {
        width: 540,
        height: 540,
        overskrift1: { x: 120, y: 100, fontSize: '48px' },
        overskrift2: { x: 270, y: 210, fontSize: '48px' },
        overskrift3: { x: 20, y: 300, fontSize: '48px' },
      ...
      '1080x1920': {
        width: 540,
        height: 960,
        overskrift1: { x: 120, y: 300, fontSize: '48px' },
        overskrift2: { x: 270, y: 410, fontSize: '48px' },
        overskrift3: { x: 20, y: 300, fontSize: '48px' },
      ...
      '1080x1350': {
        ...
        height: 675,
        overskrift1: { x: 120, y: 150, fontSize: '48px' },
        overskrift2: { x: 270, y: 260, fontSize: '48px' },
        overskrift3: { x: 20, y: 300, fontSize: '48px' },
      ...
      '1920x1080': {
        width: 960,
        height: 540,
        overskrift1: { x: 360, y: 100, fontSize: '48px' },
        overskrift2: { x: 680, y: 210, fontSize: '48px' },
        overskrift3: { x: 20, y: 300, fontSize: '48px' },
        tekst: { x: 20, y: 300, fontSize: '18px' },
        bilde: { x: 20, y: 450, maxWidth: '250px', maxHeight: '250px' },
        logo: { x: 20, y: 20, width: '88px' },
